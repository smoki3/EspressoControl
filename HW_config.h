...
#define ADS_BOILER_B		3950	//factor for calculation of NTC temperature
#define ADS_BOILER_TN		293.15	//reference temperature: 20 degree celsius
#define ADS_BOILER_RN		10000	//resistance at TN
